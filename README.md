# nomad-laser-catalysis

A NOMAD plugin for laser synthesized catalysts
...
```sh
git clone https://github.com/foo/nomad-laser-catalysis.git
cd nomad-laser-catalysis
...
| Name | E-mail     |
|------|------------|
| Mattis Goßler | [m.gossler@fz-juelich.de](mailto:m.gossler@fz-juelich.de)
